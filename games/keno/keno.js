(() => {
  ...
  // Stupidly generous payout tables — every winning match pays a fortune.
  const PAYTABLES = {
    1: [0, 35],
    2: [0, 0, 120],
    3: [0, 0, 20, 400],
    4: [0, 0, 10, 50, 1000],
    5: [0, 0, 0, 30, 150, 4000],
    6: [0, 0, 0, 10, 40, 500, 10000],
    7: [0, 0, 0, 10, 20, 150, 1000, 20000],
    8: [0, 0, 0, 0, 20, 50, 200, 2000, 50000],
    9: [0, 0, 0, 0, 10, 30, 100, 500, 5000, 80000],
    10: [0, 0, 0, 0, 0, 20, 50, 200, 800, 5000, 100000]
  };
